      ...
      <main className="flex flex-col items-center gap-8 w-full max-w-xl">
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full justify-center mt-4">
          <Link
            ...
            className="flex-1 px-6 py-4 bg-blue-600 text-white rounded-lg text-center text-lg font-semibold shadow hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-400 transition"
          >
            Image Converter
          </Link>
          {/* <Link
